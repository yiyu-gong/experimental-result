...
def run_kind2(file_name):
    ...
    kind2_command = f"/usr/bin/time -v ./IC3_SM --enable IC3QE -vv --color false --timeout 500 {file_name}.lus"
    try:
        ...
        return file_name, result, ic3_k, ic3_total_time, ic3_frame_sizes, ic3_solver,  ic3_add_sml, ic3_extra_sml, ic3_extra_time_c, ic3_extra_time_c_n1, ic3_extra_time_F, ic3_assert_time, ic3_check_sat_time, ic3_get_unsat_core_time, ic3_get_value_time,  f_sml, f_reuse_sml, sml_ind_length, sml_ind_mem, sml_init_length, sml_init_mem, i_sml, i_reuse_sml, ic3_extra_time_n0 ,ic3_max_size

    except subprocess.TimeoutExpired:
        # 如果超时，输出超时信息
        return file_name,"timeout","N/A","N/A",	"N/A",	"N/A",	"N/A",	"N/A",	"N/A",	"N/A",	"N/A",	"N/A",	"N/A",	"N/A",	"N/A","N/A",	"N/A",	"N/A",	"N/A",	"N/A",	"N/A","N/A",	"N/A",	"N/A",	"N/A",	"N/A"	

def process_model(model_file):
    file_name, result, ic3_k, ic3_total_time, ic3_frame_sizes, ic3_solver,  ic3_add_sml, ic3_extra_sml, ic3_extra_time_c, ic3_extra_time_c_n1, ic3_extra_time_F, ic3_assert_time, ic3_check_sat_time, ic3_get_unsat_core_time, ic3_get_value_time,  f_sml, f_reuse_sml, sml_ind_length, sml_ind_mem, sml_init_length, sml_init_mem, i_sml, i_reuse_sml, ic3_extra_time_n0 ,ic3_max_size = run_kind2(model_file)
    return file_name, result, ic3_k, ic3_total_time, ic3_frame_sizes, ic3_solver,  ic3_add_sml, ic3_extra_sml, ic3_extra_time_c, ic3_extra_time_c_n1, ic3_extra_time_F, ic3_assert_time, ic3_check_sat_time, ic3_get_unsat_core_time, ic3_get_value_time,  f_sml, f_reuse_sml, sml_ind_length, sml_ind_mem, sml_init_length, sml_init_mem, i_sml, i_reuse_sml, ic3_extra_time_n0 ,ic3_max_size
...
def batch_run_kind2(input_csv, output_csv):
    ...
    with open(output_csv, mode="w", newline="", encoding="utf-8") as output_csv_file:
        ...
        # writer CSV writerow
        csv_writer.writerow(["Model", "result", "ic3_k", "ic3_total_time", "ic3_frame_sizes", "ic3_solver",  "ic3_add_sml", "ic3_extra_sml", "ic3_extra_time_c", "ic3_extra_time_c_n1", "ic3_extra_time_F",  "ic3_assert_time", "ic3_check_sat_time", "ic3_get_unsat_core_time","get_value_time",  "f_sml", "f_reuse_sml",  "sml_ind_length",  "sml_ind_mem",  "sml_init_length", "sml_init_mem", "i_sml", "i_reuse_sml", "ic3_extra_time_n0","max_size"])
...
batch_run_kind2("/experimental-result-main/supplement/benchmark.csv", "IC3_SM_all.csv")
